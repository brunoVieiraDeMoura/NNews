            ...
            >
              ...
              <Box>
                ...
                <Typography
                  ...
                  variant="body1"
                >
                  {materiaMaisRecente.textPrimeiraEstrofe}
                </Typography>
              </Box>
              <Box sx={{ display: "flex", gap: 2 }}>
                <Box component="a" href={materiaMaisRecente.link}>
                  <Typography variant="body1">
          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              <Box style={{ position: "relative" }}>
                <Box component="a" href={slide.link}>
                  <CardMedia
                    component="img"
                    height="140"
                    image={slide.image}
